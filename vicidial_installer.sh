...
yum -y install https://dl.fedoraproject.org/pub/epel/epel-release-latest-8.noarch.rpm -y
...
cd /etc/include
wget https://hbtutorial.com/HBTutorial/newt.h
...
wget https://hbtutorial.com/HBTutorial/dahdi-9.5-fix.zip
